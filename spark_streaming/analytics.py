...
# Read database configuration from environment variables (safer than hardcoding)
jdbc_url = os.environ.get("JDBC_URL", "")
main_table = os.environ.get("MAIN_TABLE", "")
gainers_table = os.environ.get("GAINERS_TABLE", "")
losers_table = os.environ.get("LOSERS_TABLE", "")
db_properties = {
    "user": os.environ.get("DB_USER",""),
    "password": os.environ.get("DB_PASSWORD", ""),
    "driver": os.environ.get("DB_DRIVER", "org.postgresql.Driver")
}
...
while True:
    try:
        ...
        df = spark.read.parquet(os.environ.get("DATAFRAME_PATH") # type: ignore
        ).drop(
